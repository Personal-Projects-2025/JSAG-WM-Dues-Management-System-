            ...
            <Dialog.Panel className="w-full max-w-2xl transform overflow-hidden rounded-2xl bg-white shadow-xl transition-all">
              ...
              <form onSubmit={onSubmit} className="space-y-6 px-4 py-4 sm:px-6 sm:py-6">
                <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                  ...
                  <div className="space-y-1">
                    <label className="text-sm font-medium text-slate-700">Phone (SMS)</label>
                    <input
                      type="tel"
                      value={formData.phone}
                      onChange={(e) => setFormData({ ...formData, phone: e.target.value })}
                      placeholder="e.g. 0244123456 for receipts &amp; reminders"
                      className="w-full rounded-lg border border-slate-300 px-3 py-2 text-sm shadow-sm focus:border-blue-500 focus:outline-none focus:ring-2 focus:ring-blue-100"
                    />
                  </div>
                  <div className="space-y-1">
                ...
                <div className="space-y-6 px-4 py-4 sm:px-6 sm:py-6">
                  <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                    ...
                    <div className="rounded-lg border border-slate-200 bg-slate-50 p-4">
                      <div className="flex items-center space-x-2 text-slate-500">
                        <Phone size={16} />
                        <span className="text-xs uppercase tracking-wide">SMS phone</span>
                      </div>
                      <p className="mt-2 text-sm font-medium text-slate-800">
          ...
          return (
            <div className="space-y-1 text-sm text-slate-600">
              ...
              <div className="flex items-center space-x-2">
                ...
                <span>{member.phone || member.contact || 'N/A'}</span>
              </div>
            </div>
          );
        }
